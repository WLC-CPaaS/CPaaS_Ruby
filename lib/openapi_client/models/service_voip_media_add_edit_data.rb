  ...
  class ServiceVOIPMediaAddEditData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ServiceVOIPMediaAddEditData` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ServiceVOIPMediaAddEditData`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      media_source_validator = EnumAttributeValidator.new('String', ["upload", "recording", "tts"])
      return false unless media_source_validator.valid?(@media_source)
    ...
    # @param [Object] media_source Object to be assigned
    def media_source=(media_source)
      validator = EnumAttributeValidator.new('String', ["upload", "recording", "tts"])
      unless validator.valid?(media_source)
        fail ArgumentError, "invalid value for \"media_source\", must be one of #{validator.allowable_values}."
      end
      @media_source = media_source
    end
    ...
    def hash
      [description, media_source, name, tts].hash
    end
