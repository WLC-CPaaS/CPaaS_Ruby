  ...
  class ServiceE911LocationOutput
    ...
    def self.openapi_types
      {
        ...
        :'latitude' => :'Float',
        :'legacy_data' => :'ServiceE911LegacyDataOutput',
        :'location_id' => :'String',
        :'longitude' => :'Float',
        :'plus_four' => :'String',
        :'postal_code' => :'String',
        :'state' => :'String',
        :'status' => :'ServiceE911StatusOutput',
        :'type' => :'String',
        :'update_time' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ServiceE911LocationOutput` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ServiceE911LocationOutput`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [activated_time, address_1, address_2, caller_name, comments, community, customer_order_id, latitude, legacy_data, location_id, longitude, plus_four, postal_code, state, status, type, update_time].hash
    end
