  ...
  class ModelCallDetail
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ModelCallDetail` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ModelCallDetail`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'call_duration')
      ...
      if attributes.key?(:'call_time')
        self.call_time = attributes[:'call_time']
      end
      ...
      if attributes.key?(:'callee_name')
        self.callee_name = attributes[:'callee_name']
      end

      if attributes.key?(:'callee_number')
      ...
      if attributes.key?(:'caller_number')
    ...
    def hash
      [account_id, call_duration, call_id, call_time, call_type, callee_name, callee_number, caller_name, caller_number, created_at].hash
    end
