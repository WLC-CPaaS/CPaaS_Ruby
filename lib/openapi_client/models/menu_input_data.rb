  ...
  class MenuInputData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::MenuInputData` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::MenuInputData`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@timeout.nil? && @timeout > 60000
        invalid_properties.push('invalid value for "timeout", must be smaller than or equal to 60000.')
      end
    ...
    def valid?
      ...
      return false if !@timeout.nil? && @timeout > 60000
    ...
    def timeout=(timeout)
      ...
      if timeout > 60000
        fail ArgumentError, 'invalid value for "timeout", must be smaller than or equal to 60000.'
      end
