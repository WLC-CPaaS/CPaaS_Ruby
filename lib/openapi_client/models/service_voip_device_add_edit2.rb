...
module OpenapiClient
  class ServiceVOIPDeviceAddEdit2
    ...
    def self.openapi_types
      {
        :'call_forward' => :'ModelsCallForward',
        :'caller_id' => :'ServiceVOIPDeviceAddEdit3c',
        :'device_type' => :'String',
        :'do_not_disturb' => :'ModelsVOIPSharedDoNotDisturb',
        :'enabled' => :'Boolean',
        :'mac_address' => :'String',
        :'media' => :'ServiceVOIPDeviceAddEdit3d',
        :'music_on_hold' => :'ModelsMusicOnHold',
        :'name' => :'String',
        :'owner_id' => :'String',
        :'provision' => :'ServiceVOIPDeviceAddEditProvision',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ServiceVOIPDeviceAddEdit2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ServiceVOIPDeviceAddEdit2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'call_forward')
        self.call_forward = attributes[:'call_forward']
      end
    ...
    def list_invalid_properties
      ...
      if @sip.nil?
        invalid_properties.push('invalid value for "sip", sip cannot be nil.')
      end
    ...
    def valid?
      ...
      device_type_validator = EnumAttributeValidator.new('String', ["softphone", "sip_uri", "sip_device"])
      return false unless device_type_validator.valid?(@device_type)
      return false if @name.nil?
      return false if @name.to_s.length > 128
      return false if @sip.nil?
      true
    end
    ...
    def device_type=(device_type)
      validator = EnumAttributeValidator.new('String', ["softphone", "sip_uri", "sip_device"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] sip Value to be assigned
    def sip=(sip)
      if sip.nil?
        fail ArgumentError, 'sip cannot be nil'
      end
    ...
    def hash
      [call_forward, caller_id, device_type, do_not_disturb, enabled, mac_address, media, music_on_hold, name, owner_id, provision, sip].hash
    end
